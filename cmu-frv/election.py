# ALL CREDIT TO: https://github.com/CMU-Senate/fair-ranked-voting
...
class Candidate:
    ...
    def __repr__(self):
        ...
        """
        return 'Candidate({!r})'.format(self.uid)
    ...
    def __str__(self):
        ...
        Returns:
            String containing the printable representation of the Candidate.
        """
        return self.uid + "<|>" + str(self.votes)
    ...
    def candidates_reaching_threshold(self, candidates, threshold):
        ...
        for candidate in candidates:
            if self.votes_for_candidate(candidate) >= threshold:
                ...
                candidate.votes = self._votes_for_candidate[candidate]
